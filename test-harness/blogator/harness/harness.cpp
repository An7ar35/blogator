 ...
 */
std::vector<std::pair<test_harness::blogator::ConfigurationTkTest, std::filesystem::path>> test_harness::blogator::loadTokeniserTests( const std::filesystem::path &test_dir ) {
