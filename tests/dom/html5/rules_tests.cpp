...
#include "../../../src/dom/html5/rules.h"
#include "../../../src/exception/DOMException.h"

TEST( HTML5rules_Tests, isTagEnd_pass ) {
    ASSERT_TRUE( blogator::dom::html5::rules::isTagEnd( U'>' ) );
}

TEST( HTML5rules_Tests, isTagEnd_fail ) {
    ASSERT_FALSE( blogator::dom::html5::rules::isTagEnd( U' ' ) );
    ASSERT_FALSE( blogator::dom::html5::rules::isTagEnd( U'<' ) );
    ASSERT_FALSE( blogator::dom::html5::rules::isTagEnd( U'/' ) );
    ASSERT_FALSE( blogator::dom::html5::rules::isTagEnd( U'a' ) );
}

TEST( HTML5rules_Tests, isValidCharReference1 ) {
    using blogator::dom::html5::rules::isValidCharReference;
...
TEST( HTML5rules_Tests, validateOpeningTag ) {
    ...
    using blogator::dom::html5::rules::validateOpeningTag;
    auto str = U"<>";
...
TEST( HTML5rules_Tests, validateClosingingTag_fail0 ) {
    using blogator::exception::DOMException;
    using blogator::dom::html5::rules::validateClosingTag;
    auto str = U"";
...
TEST( HTML5rules_Tests, validateAttributes_fail1 ) {
    using blogator::dom::html5::rules::validateAttributes;
    auto str = U"\"";
    auto v   = std::vector<std::pair<std::u32string, std::u32string>>();
