...
namespace blogator::unicode {
    ...
    static constexpr uint32_t LEFT_PARENTHESIS       { 0x28 }; //'('
    static constexpr uint32_t RIGHT_PARENTHESIS      { 0x29 }; //')'
    ...
    static constexpr uint32_t FULL_STOP              { 0x2E }; //'.'
