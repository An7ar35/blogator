...
namespace blogator::unicode::utf8 {
    ...
    uint32_t toU32( uint8_t u8_byte1 );
    uint32_t toU32( uint8_t u8_byte1, uint8_t u8_byte2 );
    uint32_t toU32( uint8_t u8_byte1, uint8_t u8_byte2, uint8_t u8_byte3 );
    uint32_t toU32( uint8_t u8_byte1, uint8_t u8_byte2, uint8_t u8_byte3, uint8_t u8_byte4 );
