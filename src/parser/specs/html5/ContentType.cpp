 ...
 */
std::ostream & blogator::parser::specs::html5::operator <<( std::ostream &os, blogator::parser::specs::html5::ContentType content_type ) {
    switch( content_type ) {
...
/**
 * Converts a parser::specs::html5::ContentType enum to a string representation
 * @param content_type ContentType enum
 * @return String representation
 */
std::string blogator::to_string( blogator::parser::specs::html5::ContentType content_type ) {
    std::stringstream ss;
    ss << content_type;
    return ss.str();
}
 ...
 * @return String representation
 */
std::u32string blogator::to_u32string( blogator::parser::specs::html5::ContentType content_type ) {
