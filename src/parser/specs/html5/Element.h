...
namespace blogator::parser::specs::html5 {
    enum class Element {
        ...
        ATTRIBUTE_NAME, ATTRIBUTE_ASSIGN, ATTRIBUTE_VALUE_START, ATTRIBUTE_VALUE_END,
        TAG_OPEN, TAG_CLOSE, TAG_CLOSE_SELF,
        ...
        HTML5_H1, HTML5_H2, HTML5_H3, HTML5_H4, HTML5_H5, HTML5_H6, HTML5_HEAD, HTML5_HEADER, HTML5_HR, HTML5_HTML,
