...
std::ostream & blogator::parser::specs::markdown::operator <<( std::ostream &os, blogator::parser::specs::markdown::TokeniserState state ) {
    static const auto map = std::unordered_map<TokeniserState, std::string>( {
        ...
        { TokeniserState::BLOCK_BEGIN_UNDERSCORE,                                                                        "BLOCK_BEGIN (\"_\")" },
        { TokeniserState::BLOCK_BEGIN_UNDERSCORE_UNDERSCORE,                                                             "BLOCK_BEGIN (\"__\")" },
        { TokeniserState::BLOCK_BEGIN_ASTERISK,                                                                          "BLOCK_BEGIN (\"*\")" },
        { TokeniserState::BLOCK_BEGIN_ASTERISK_ASTERISK,                                                                 "BLOCK_BEGIN (\"**\")" },
        { TokeniserState::BLOCK_BEGIN_ASTERISK_SPACE,                                                                    "BLOCK_BEGIN (\"* \")" },
        { TokeniserState::BLOCK_BEGIN_HYPHEN,                                                                            "BLOCK_BEGIN (\"-\")" },
        { TokeniserState::BLOCK_BEGIN_HYPHEN_HYPHEN,                                                                     "BLOCK_BEGIN (\"--\")" },
        { TokeniserState::BLOCK_BEGIN_HYPHEN_SPACE,                                                                      "BLOCK_BEGIN (\"- \")" },
        ...
        { TokeniserState::HEADING_BLOCK_ATX_TEXT_AFTER_CLOSING_BLOCK_ID,                                                 "HEADING_BLOCK_ATX_TEXT_AFTER_CLOSING_BLOCK_ID" },
