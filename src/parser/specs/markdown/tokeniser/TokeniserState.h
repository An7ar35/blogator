#ifndef BLOGATOR_PARSER_SPECS_MARKDOWN_TOKENISER_TOKENISERSTATE_H
#define BLOGATOR_PARSER_SPECS_MARKDOWN_TOKENISER_TOKENISERSTATE_H
...
namespace blogator::parser::specs::markdown {
    ...
    enum class TokeniserState {
        ...
        HEADING_BLOCK_ATX_TEXT_AFTER_CLOSING_BLOCK_ID,
...
#endif //BLOGATOR_PARSER_SPECS_MARKDOWN_TOKENISER_TOKENISERSTATE_H