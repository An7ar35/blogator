...
namespace blogator::parser::specs::markdown {
    ...
    enum class TokeniserState {
        ...
        BLOCK_BEGIN_HYPHEN_SPACE_SPACE,
        BLOCK_BEGIN_HYPHEN_TAB,
        ...
        HTML_BLOCK_BEGIN,
        HTML_BLOCK_BEGIN_END_TAG_OPEN,
        HTML_BLOCK_BEGIN_MARKUP_DECLARATION,
        HTML_BLOCK_BEGIN_TAG_NAME,
        HTML_BLOCK_BEGIN_BEFORE_ATTRIBUTE_NAME,
        HTML_BLOCK_BEGIN_ATTRIBUTE_NAME,
        HTML_BLOCK_BEGIN_AFTER_ATTRIBUTE_NAME,
        HTML_BLOCK_BEGIN_BEFORE_ATTRIBUTE_VALUE,
        HTML_BLOCK_BEGIN_ATTRIBUTE_VALUE_DOUBLE_QUOTED,
        HTML_BLOCK_BEGIN_ATTRIBUTE_VALUE_SINGLE_QUOTED,
        HTML_BLOCK_BEGIN_ATTRIBUTE_VALUE_UNQUOTED,
        HTML_BLOCK_BEGIN_AFTER_ATTRIBUTE_VALUE_QUOTED,
        HTML_BLOCK_BEGIN_SELF_CLOSING_START_TAG,
        HTML_BLOCK_BEGIN_TAG_RESOLVE,
        HTML_BLOCK_BEGIN_CONCLUSION,
        HTML_BLOCK_CONTENT,
        HTML_BLOCK_CONTENT_NEWLINE,
        HTML_BLOCK_CONTENT_TAG_OPEN,
        HTML_BLOCK_END_END_TAG_OPEN,
        HTML_BLOCK_END_TAG_NAME,
        HTML_BLOCK_END_TAG_AFTER_TAG_NAME,
