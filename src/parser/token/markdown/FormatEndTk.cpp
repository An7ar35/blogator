 ...
 */
FormatEndTk::FormatEndTk( blogator::TextPos position ) :
 ...
 * @param position Line:Col position of token in source text
 */
FormatEndTk::FormatEndTk( std::u32string text, blogator::TextPos position ) :
 ...
 * @param position Line:Col position of token in source text
 */
FormatEndTk::FormatEndTk( uint32_t c, blogator::TextPos position ) :
 ...
 * @param position Line:Col position of token in source text
 */
FormatEndTk::FormatEndTk( uint32_t c1, uint32_t c2, blogator::TextPos position ) :
