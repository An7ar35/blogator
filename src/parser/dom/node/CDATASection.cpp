 ...
 */
Node * CDATASection::insertNodeBefore( [[maybe_unused]] NodePtr_t node, [[maybe_unused]] Node * child ) {
 ...
 */
blogator::parser::dom::NodePtr_t CDATASection::replaceChildNode( [[maybe_unused]] NodePtr_t &node, [[maybe_unused]] NodePtr_t &target ) {
    using exception::DOMException;
    using exception::DOMExceptionType;
 ...
 */
void CDATASection::toUTF8Stream( std::ostream &os ) const {
    os << "<!CDATA[";
